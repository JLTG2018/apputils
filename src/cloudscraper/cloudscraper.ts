...
export function get(url, callback, headers) {
    return performRequest({ //JLTG2018> returning request object
        method: 'GET',
        url: url,
        headers: headers
    }, callback);
...
function performRequest(options, callback) {
    ...
    return makeRequest(options, function(error, response, body) { //JLTG2018> returning request object
